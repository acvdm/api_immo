...
- Fonctionnalités détaillées:
  ...
  - Room management: Attributs: id, property_id, type (bedroom/kitchen/etc.), size (m2)  
...
- architecture trop complexe avec des Microservices: architecture monolithique modulaire Flask
